...
let hayPendientes = alumnos.some(
  (alumno) => alumno.practicasEntregadas < alumno.practicasTotales
);

if (hayPendientes) {
  console.log("Faltan prácticas por entregar");
} else {
  console.log("Todas las prácticas están entregadas");
}
