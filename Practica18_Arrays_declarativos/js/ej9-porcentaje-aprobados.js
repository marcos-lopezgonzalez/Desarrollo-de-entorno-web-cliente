...
let nAprobados = alumnos.reduce(
  (acumulador, alumno) => (alumno.notaMedia >= 5 ? acumulador + 1 : acumulador),
  0
);

console.log(nAprobados + " de " + alumnos.length);

console.log((nAprobados * 100 / alumnos.length).toFixed(2) + "% de aprobados");
